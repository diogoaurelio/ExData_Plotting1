...
#1
plot(data$Global_active_power~data$DatePlusTime, type="l", ylab="Global Active Power", xlab="")
#2
plot(data$Voltage~data$DatePlusTime, type="l", ylab="Voltage", xlab="datetime")
#3
plot(data$Sub_metering_1~data$DatePlusTime, type="l", ylab="Energy sub metering", xlab="")
lines(data$Sub_metering_2~data$DatePlusTime,col='Red')
lines(data$Sub_metering_3~data$DatePlusTime,col='Blue')
...
#4
plot(data$Global_reactive_power~data$DatePlusTime, type="l", ylab="Global_reactive_power",xlab="datetime")
